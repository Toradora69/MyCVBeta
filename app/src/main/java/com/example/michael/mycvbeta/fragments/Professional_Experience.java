 ...
 */
public class Professional_Experience extends Fragment implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    ViewPager viewPager;
...
//        vq = inflater.inflate(R.layout.tabfragment_3, container, false);
        iCV++;


//         this.greenbytelogo = (ImageView)vq.findViewById(R.id.greenbyteInfoId);
//         this.greenbytelogo.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//    {
//
//        //View tabView = tabHost.getChildAt(2);
//
//       // myView.setVisibility(View.INVISIBLE);
//
//
//        ImageView iv = (ImageView) tabHost.getCurrentView().findViewById(R.id.greenbyteInfoId);
