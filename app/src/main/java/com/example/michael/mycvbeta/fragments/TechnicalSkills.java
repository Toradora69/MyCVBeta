 ...
 */
public class TechnicalSkills extends Fragment implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    ViewPager viewPager;
...
//        Toast.makeText(getContext(), myDataFromActivity, Toast.LENGTH_LONG).show();
    ...
    private void initTabHost(Bundle args, int fragId) {
        ...
        for (int i = 0; i < tabNames.length; i++) {
            ...
            whiteIconPaint(a);
//            a.setColorFilter(new PorterDuffColorFilter(0xffff00,PorterDuff.Mode.MULTIPLY));
